...
## ROC for Final Decision Tree Model Section
...
# Comparing Predictive Performance Between All Models
...
Comparing the final logistic regression, neural network, and final decision tree models, all of them are better than the random guess and the predictive powers for these underlying models are all acceptable.
The AUC for the final logistic regression model ROC, however, is significantly larger than that for the other two models. Therefore, the final logistic regression model has a better predictive performance than the other two and is the best model to use for predictive modeling of the data set out of the three.
